const objFullExcuse = {
    arrayWho: ['Un perro ', 'Una vieja ', 'Donald Trump ','Roberto Torres ','Javier Verón ', 'El cartero ', 'Bad Bunny ','Un dinosaurio ', 'Un gato ','Batman ','Un alien ', 'Toda la población de Uganda ', 'Una señora china ', 'Un testigo de Jehova ','El vecino de arriba ','Elon Musk ', 'Pedro Sánchez ','Ibai Llanos ','Un gnomo muy enfadado ','Un streamer '],
    arrayAction: ['cortó por la mitad ','mordió ', 'se comió ', 'explotó ','tiró por la ventana ','robó ','destruyó con un láser ','vendió ','convirtió en oveja ','hackeó ','compró ','vendió en el mercado negro ','se tropezó con '],
